...
class WebTest_HREmerg_HREmergAddEditTest extends CiviSeleniumTestCase {
  ...
  function _addEmergData($values, $new = FALSE, $mode = NULL) {
    if ($new) {
      $this->click("xpath=//a[@title='Relationships']");
      $this->waitForElementPresent("xpath=//div[@id='Relationships']/div/div/div/div/a/span");
      $this->click("xpath=//div[@id='Relationships']/div/div/div/div/a/span");
