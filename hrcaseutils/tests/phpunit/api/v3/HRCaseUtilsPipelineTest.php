...
class api_v3_HRCaseUtils_HRCaseUtilsPipelineTest extends CiviUnitTestCase{
    ...
    public function testPipeline() { 
        ...
        $contact = $this->callAPISuccess('contact', 'create', array( 'first_name' => 'JohnHR',
        ...
        $newParams = array(
                           ...
                           'status_id' => 1,
                           //'start_date' => '01/07/2014',//'2013-11-11 01:00:00',
                           //'end_date' => '2013-11-12 01:00:00',
        ...
        $caseContact->case_id = $caseBAO->id;//$params['case_id'];
        $caseContact->contact_id = $contact['id'];//$params['contact_id'];
