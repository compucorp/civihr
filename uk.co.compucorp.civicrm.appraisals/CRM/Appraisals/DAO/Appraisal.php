    ...
    if (!(self::$_fields)) {
      self::$_fields = array(
        'id' => array(
          ...
          'headerPattern' => '/^appraisal\s?id/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
        ) ,
        ...
        'self_appraisal_file_id' => array(
          ...
          'headerPattern' => '/^self\s?appraisal\s?file\s?id/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
        ) ,
        'manager_appraisal_file_id' => array(
          ...
          'headerPattern' => '/^manager\s?appraisal\s?file\s?id/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
        ) ,
        'self_appraisal_due' => array(
          ...
          'headerPattern' => '/^self\s?appraisal\s?due/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
          'html' => array(
        ...
        'manager_appraisal_due' => array(
          ...
          'headerPattern' => '/^manager\s?appraisal\s?due/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
          'html' => array(
        ...
        'due_changed' => array(
          ...
          'headerPattern' => '/^is\s?any\s?individual\s?due\s?date\s?changed/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
          'html' => array(
        ...
        'meeting_date' => array(
          ...
          'headerPattern' => '/^meeting\s?date/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
          'html' => array(
        ...
        'meeting_completed' => array(
          ...
          'headerPattern' => '/^is\s?meeting\s?completed\s?/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
          'html' => array(
        ...
        'approved_by_employee' => array(
          ...
          'headerPattern' => '/^is\s?approved\s?by\s?employee/i',
          'dataPattern' => '',
          'export' => true,
          'default' => true,
          'html' => array(
