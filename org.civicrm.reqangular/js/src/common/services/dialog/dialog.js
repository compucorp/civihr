...
define([
  ...
  function DialogService ($modal, $rootElement, $templateCache) {
     ...
     * @param  {Promise} options.onConfirm is executed on the confirmation button click
     * @param  {Promise} options.onCloseAfterConfirm is executed on the confirmation button click after modal closes
