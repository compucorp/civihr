...
class CRM_Hrjobcontract_BAO_HRJobPension extends CRM_Hrjobcontract_DAO_HRJobPension {
  /**
   * static field for the HRJobPension information that we can potentially import
   *
   * @var array
   * @static
   */
   ...
   * @static
   */
  static function importableFields($contactType = 'HRJobPension',
    $status          = FALSE,
    $showAll         = FALSE,
    $isProfile       = FALSE,
    ...
    if (!$fields) {
      ...
      $fields = array_merge($fields, CRM_Hrjobcontract_DAO_HRJobPension::import());
