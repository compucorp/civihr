...
class CRM_Hrjobcontract_BAO_HRJobRole extends CRM_Hrjobcontract_DAO_HRJobRole {
   ...
   * @static
   */
  static function importableFields($contactType = 'HRJobRole',
    $status          = FALSE,
    $showAll         = FALSE,
    $isProfile       = FALSE,
    ...
    if (!$fields) {
      $fields = CRM_Hrjobcontract_DAO_HRJobRole::import();

      $fields = array_merge($fields, CRM_Hrjobcontract_DAO_HRJobRole::import());
