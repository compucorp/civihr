define([
    ...
    services.factory('ContractRevisionService', ['$filter', '$resource', 'settings', '$q', 'UtilsService', '$log',
        function ($filter, $resource, settings, $q, UtilsService, $log) {
            $log.debug('Service: ContractRevisionService');

        var ContractRevision = $resource(settings.pathRest, {
            action: 'get',
