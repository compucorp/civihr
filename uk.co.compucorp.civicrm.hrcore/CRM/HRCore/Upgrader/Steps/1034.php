...
trait CRM_HRCore_Upgrader_Steps_1034 {
  ...
  public function upgrade_1034() {
    $this->up1034_modifyNewIndividualMenu();
    $this->up1034_createStaffDirectoryMenu();
    $this->up1034_createCommunicationsMenu();
    $this->up1034_moveNewEmailSubmenu();
    $this->up1034_createCommunicationsSubmenus();
    $this->up1034_removeOldMenuItems([
      'New Organisation',
      'New Organization',
      'New Group',
      'Manage Groups',
    ...
    $this->up1034_disableImportMenus([
      'Import Contacts',
   ...
   */
  private function up1034_modifyNewIndividualMenu() {
   ...
   */
  private function up1034_createStaffDirectoryMenu() {
   ...
   */
  private function up1034_createCommunicationsMenu() {
    $menu = civicrm_api3('Navigation', 'get', [
      'name' => 'Add New Staff Member',
    ]);
   ...
   */
  private function up1034_moveNewEmailSubmenu() {
    $menu = civicrm_api3('Navigation', 'get', [
      'name' => 'Record Communication',
    ]);
   ...
   */
  private function up1034_createCommunicationsSubmenus() {
    $menu = civicrm_api3('Navigation', 'get', [
      'name' => 'Record Communication',
    ]);
   ...
   * @param array $menus
   */
  private function up1034_removeOldMenuItems($menus) {
   ...
   * @param array $menus
   */
  private function up1034_disableImportMenus($menus) {
    foreach ($menus as $menuLabel) {
      civicrm_api3('Navigation', 'get', [
        'name' => $menuLabel,
