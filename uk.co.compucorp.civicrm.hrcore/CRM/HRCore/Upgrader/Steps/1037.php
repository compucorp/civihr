...
trait CRM_HRCore_Upgrader_Steps_1037 {
  ...
  public function upgrade_1037() {
    $this->up1037_modifyNewIndividualMenu();
    $this->up1037_createStaffDirectoryMenu();
    $this->up1037_createCommunicationsMenu();
    $this->up1037_moveNewEmailSubmenu();
    $this->up1037_createCommunicationsSubmenus();
    $this->up1037_removeOldMenuItems([
      'New Organisation',
      'New Organization',
      'New Group',
      'Manage Groups',
    ...
    $this->up1037_disableImportMenus([
      'Import Contacts',
   ...
   */
  private function up1037_modifyNewIndividualMenu() {
   ...
   */
  private function up1037_createStaffDirectoryMenu() {
   ...
   */
  private function up1037_createCommunicationsMenu() {
    $menu = civicrm_api3('Navigation', 'get', [
      'name' => 'Add New Staff Member',
    ]);
   ...
   */
  private function up1037_moveNewEmailSubmenu() {
    $menu = civicrm_api3('Navigation', 'get', [
      'name' => 'Record Communication',
    ]);
   ...
   */
  private function up1037_createCommunicationsSubmenus() {
    $menu = civicrm_api3('Navigation', 'get', [
      'name' => 'Record Communication',
    ]);
   ...
   * @param array $menus
   */
  private function up1037_removeOldMenuItems($menus) {
   ...
   * @param array $menus
   */
  private function up1037_disableImportMenus($menus) {
    foreach ($menus as $menuLabel) {
      civicrm_api3('Navigation', 'get', [
        'name' => $menuLabel,
