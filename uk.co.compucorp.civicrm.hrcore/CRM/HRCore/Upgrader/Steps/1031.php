...
trait CRM_HRCore_Upgrader_Steps_1031 {
  ...
  public function upgrade_1031() {
    $this->up1031_deleteDefaultGroups([
      'Advisory board',
    ...
    $this->up1031_disableAndHideDefaultGroup('Case_Resources');
   ...
   */
  private function up1031_deleteDefaultGroups($groupsToDelete) {
   ...
   */
  private function up1031_disableAndHideDefaultGroup($groupToHide) {
