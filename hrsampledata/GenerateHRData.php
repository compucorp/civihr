  ...
  */
  private function addAbsencePeriods() {
    ...
    $periods[] = array(
      ...
      'start_data' => '2013-01-01 00:00:00',
      'end_data' => '2013-12-31 23:59:59',
    );

    $periods[] = array(
      'name' => 'FY2014',
      'title' => 'Fiscal Year 2014',
      'start_data' => '2014-01-01 00:00:00',
      'end_data' => '2014-12-31 23:59:59',
    );

    $periods[] = array(
      'name' => 'FY2015',
      'title' => 'Fiscal Year 2015',
      'start_data' => '2015-01-01 00:00:00',
      'end_data' => '2015-12-31 23:59:59',
    );

    $periods[] = array(
      'name' => 'FY2016',
      'title' => 'Fiscal Year 2016',
      'start_data' => '2016-01-01 00:00:00',
      'end_data' => '2016-12-31 23:59:59',
    );
