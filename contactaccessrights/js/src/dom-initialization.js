  ...
  return {
    ...
    addAppToDOM: function () {
      ...
      var appElement = angular.element('<li id="access-rights"> ' +
          '<div ng-controller="AccessRightsController as accessRights" id="bootstrap-theme"> ' +
            '<a href class="edit button pull-right" ng-click="accessRights.openModal()" id="manage-roles-and-teams"> ' +
