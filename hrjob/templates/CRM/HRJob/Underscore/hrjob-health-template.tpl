...
<form>
  ...
  <div class="crm-summary-row">
    <div class="crm-label">
      <label for="hrjob-provider">{ts}Provider{/ts}&nbsp;{help id='access-health-provider' file='CRM/HRJob/Page/helptext'}</label>
    </div>
  ...
  <div class="crm-summary-row">
    <div class="crm-label">
      <label for="hrjob-dependents">{ts}Dependents{/ts}&nbsp;{help id='access-dependents' file='CRM/HRJob/Page/helptext'}</label>
    </div>
    <div class="crm-content">
  ...
  <div class="crm-summary-row">
    <div class="crm-label">
      <label for="hrjob-provider_life_insurance">{ts}Provider{/ts}&nbsp;{help id='access-life-provider' file='CRM/HRJob/Page/helptext'}</label>
    </div>
    <div class="crm-content">
  ...
  <div class="crm-summary-row">
    <div class="crm-label">
      <label for="hrjob-dependents_life_insurance">{ts}Dependents{/ts}&nbsp;{help id='access-dependents' file='CRM/HRJob/Page/helptext'}</label>
    </div>
    <div class="crm-content">
