...
<form>
  ...
  <div class="crm-summary-row">
    <div class="crm-label">
      <label for="hrjob-provider">{ts}Provider{/ts}&nbsp;{help id='access-provider' file='CRM/HRJob/Page/helptext'}</label>
    </div>
  ...
  <div class="crm-summary-row">
    <div class="crm-label">
      <label for="hrjob-provider_life_insurance">{ts}Provider{/ts}&nbsp;{help id='access-provider' file='CRM/HRJob/Page/helptext'}</label>
    </div>
    <div class="crm-content">
