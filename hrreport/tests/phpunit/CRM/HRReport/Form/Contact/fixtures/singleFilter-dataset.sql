...
INSERT INTO `civicrm_hrjob` (`id`, `contact_id`, `position`, `title`, `funding_notes`, `contract_type`, `level_type`, `period_type`, `period_start_date`, `period_end_date`, `manager_contact_id`, `location`, `is_primary`, `department`) VALUES
(1, 211, 'Position-211-1', 'Title-211-1', NULL, 'Contractor', 'Senior Staff', 'Permanent', '2012-03-01', '2015-01-26', 211, 'Headquarters', 1, 'Dept-211'),
(4, 219, 'Position-219-4', 'Title-219-4', NULL, 'Apprentice', 'Junior Staff', NULL,        '2011-11-23', '2013-04-17', 206, NULL, 1, 'Dept-219'),
(6, 213, 'Position-213-6', 'Title-213-6', NULL, 'Employee', 'Junior Manager', 'Temporary', '2010-10-10', '2020-01-25', 213, 'Home', 1, 'Dept-213');
