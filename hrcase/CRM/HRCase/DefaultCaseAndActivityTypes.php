...
class CRM_HRCase_DefaultCaseAndActivityTypes {
  ...
  public static function getDefaultActivityTypesManagedRecords() {
    $activityTypesList = [];
    $activityTypes = self::getDefaultActivityTypes();

    foreach ($activityTypes as $activityType) {
      $activityTypesList[] =  [
        'name' => 'civitask:act:' . $activityType,
        'entity' => 'OptionValue',
        'params' =>
          [
            'version' => 3,
  ...
  public static function getDefaultCaseTypesManagedRecords() {
    return self::$caseTypesList;
  }
