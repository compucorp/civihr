...
require_once EXTENSION_ROOT_DIR . 'CRM/CiviHRSampleData/Importer/VacancyValue.php';

use CRM_HRCore_Test_Fabricator_Case as CaseFabricator;

/**
 * Class CRM_CiviHRSampleData_Importer_VacancyValueTest
 *
 * @group headless
 */
class CRM_CiviHRSampleData_Importer_VacancyValueTest extends CRM_CiviHRSampleData_BaseImporterTest {
  ...
  public function testImport() {
    ...
    $this->runImporter('CRM_CiviHRSampleData_Importer_VacancyValue', $this->rows, $mapping);
