...
require_once EXTENSION_ROOT_DIR . 'CRM/CiviHRSampleData/Importer/JobContract.php';
...
/**
 * Class CRM_CiviHRSampleData_Importer_JobContractTest
 *
 * @group headless
 */
class CRM_CiviHRSampleData_Importer_JobContractTest extends CRM_CiviHRSampleData_BaseImporterTest {
  ...
  public function testImport() {
    ...
    $this->runImporter('CRM_CiviHRSampleData_Importer_JobContract', $this->rows, $mapping);
