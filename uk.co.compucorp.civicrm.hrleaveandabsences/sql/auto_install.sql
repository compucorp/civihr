...
,
    ...
    ,     UNIQUE INDEX `unique_absence_period`(
        title
  )
...
CREATE TABLE `civicrm_hrleaveandabsences_absence_type` (
     ...
     `title` varchar(127) NOT NULL   COMMENT 'The AbsenceType title. There can\'t be more than one entity with the same title',
     `weight` int unsigned NOT NULL   COMMENT 'The weight value is used to order the types on a list',
...
,
    ...
    ,     UNIQUE INDEX `unique_pattern_per_effective_date`(
        contact_id
      , effective_date
  )
  
,          CONSTRAINT FK_civicrm_hrleaveandabsences_contact_work_pattern_contact_id FOREIGN KEY (`contact_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_hrleaveandabsences_contact_work_pattern_pattern_id FOREIGN KEY (`pattern_id`) REFERENCES `civicrm_hrleaveandabsences_work_pattern`(`id`) ON DELETE CASCADE  
)    ;
...
,
    ...
    ,     UNIQUE INDEX `unique_expiry_record`(
        expired_balance_change_id
  )
  ,     INDEX `index_source_id`(
        source_id
      , source_type
  )
  
,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_balance_change_expired_balance_change_id FOREIGN KEY (`expired_balance_change_id`) REFERENCES `civicrm_hrleaveandabsences_leave_balance_change`(`id`) ON DELETE CASCADE  
)    ;
...
,
    ...
    ,     UNIQUE INDEX `unique_entitlement`(
        period_id
      , contact_id
      , type_id
  )
  
,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_period_entitlement_period_id FOREIGN KEY (`period_id`) REFERENCES `civicrm_hrleaveandabsences_absence_period`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_period_entitlement_type_id FOREIGN KEY (`type_id`) REFERENCES `civicrm_hrleaveandabsences_absence_type`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_period_entitlement_contact_id FOREIGN KEY (`contact_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_period_entitlement_editor_id FOREIGN KEY (`editor_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE CASCADE  
)    ;
...
,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_period_entitlement_log_entitlement_id FOREIGN KEY (`entitlement_id`) REFERENCES `civicrm_hrleaveandabsences_leave_period_entitlement`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_period_entitlement_log_editor_id FOREIGN KEY (`editor_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE CASCADE  
)    ;
...
CREATE TABLE `civicrm_hrleaveandabsences_leave_request` (
     ...
     `notes` text    COMMENT 'A note about the request, left by the manager.' 
,
        PRIMARY KEY (`id`)
 
 
,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_request_type_id FOREIGN KEY (`type_id`) REFERENCES `civicrm_hrleaveandabsences_absence_type`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_request_contact_id FOREIGN KEY (`contact_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE CASCADE  
)    ;
...
,
    ...
    ,     UNIQUE INDEX `unique_calendar_title`(
        title
  )
  ,     UNIQUE INDEX `unique_calendar_hash`(
        hash
  )
...
CREATE TABLE `civicrm_hrleaveandabsences_leave_request_date` (
     ...
     `date` date NOT NULL   COMMENT 'A date part of the Leave Request.',
...
,
    ...
    ,     UNIQUE INDEX `unique_leave_request_date`(
        date
      , leave_request_id
  )
  
,          CONSTRAINT FK_civicrm_hrleaveandabsences_leave_request_date_leave_request_id FOREIGN KEY (`leave_request_id`) REFERENCES `civicrm_hrleaveandabsences_leave_request`(`id`) ON DELETE CASCADE  
)    ;
...
,          CONSTRAINT FK_civicrm_hrleaveandabsences_notification_receiver_type_id FOREIGN KEY (`type_id`) REFERENCES `civicrm_hrleaveandabsences_absence_type`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_hrleaveandabsences_notification_receiver_contact_id FOREIGN KEY (`contact_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE CASCADE  
)    ;
...
CREATE TABLE `civicrm_hrleaveandabsences_public_holiday` (
     ...
     `id` int unsigned NOT NULL AUTO_INCREMENT  COMMENT 'Unique PublicHoliday ID',
...
CREATE TABLE `civicrm_hrleaveandabsences_work_day` (
     ...
     `time_from` char(5)    COMMENT 'The start time of this work day. This field is a char because CiviHR can\'t handle TIME fields.',
     `time_to` char(5)    COMMENT 'The end time of this work day. This field is a char because CiviHR can\'t handle TIME fields.',
...
,
    ...
    ,     UNIQUE INDEX `unique_day_for_week`(
        week_id
      , day_of_the_week
  )
  
,          CONSTRAINT FK_civicrm_hrleaveandabsences_work_day_week_id FOREIGN KEY (`week_id`) REFERENCES `civicrm_hrleaveandabsences_work_week`(`id`) ON DELETE CASCADE  
)    ;
...
,
    ...
    ,     UNIQUE INDEX `work_pattern_unique_label`(
        label
  )
...
,          CONSTRAINT FK_civicrm_hrleaveandabsences_work_week_pattern_id FOREIGN KEY (`pattern_id`) REFERENCES `civicrm_hrleaveandabsences_work_pattern`(`id`) ON DELETE CASCADE  
)    ;
