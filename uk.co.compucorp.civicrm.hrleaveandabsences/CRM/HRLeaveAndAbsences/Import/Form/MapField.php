 ...
 */
class CRM_HRLeaveAndAbsences_Import_Form_MapField extends CRM_Import_Form_MapField {
  ...
  public function preProcess() {
    ...
    $requiredFields = array_column(BaseParser::getFields(), 'title', 'name');
  ...
  public function buildQuickForm() {
    ...
    $this->addFormRule(array('CRM_HRLeaveAndAbsences_Import_Form_MapField', 'formRule'));
  ...
  public static function formRule($fields) {
    ...
    if (!empty($fields['saveMapping'])) {
      ...
      if (empty($nameField)) {
        ...
        $mappingTypeId = CRM_Core_OptionGroup::getValue('mapping_type', 'Import Leave Request', 'name');
