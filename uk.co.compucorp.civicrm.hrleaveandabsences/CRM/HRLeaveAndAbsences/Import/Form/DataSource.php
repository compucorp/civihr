 ...
 */
class CRM_HRLeaveAndAbsences_Import_Form_DataSource extends CRM_Import_Form_DataSource {

  const PATH = 'civicrm/admin/leaveandabsences/import';

  const IMPORT_ENTITY = 'LeaveRequest';
  ...
  public function postProcess() {
    ...
    $this->submitFileForMapping(CRM_HRLeaveAndAbsences_Import_Parser_Base::class);
  }
