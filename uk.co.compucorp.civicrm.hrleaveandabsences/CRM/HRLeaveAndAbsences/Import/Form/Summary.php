 ...
 */
class CRM_HRLeaveAndAbsences_Import_Form_Summary extends CRM_Import_Form_Summary {
  ...
  public function preProcess() {
    ...
    if ($duplicateRowCount > 0) {
      $urlParams = 'type=' . CRM_Import_Parser::DUPLICATE . '&parser=CRM_HRLeaveAndAbsences_Import_Parser';
