...
class CRM_HRLeaveAndAbsences_DAO_LeavePeriodEntitlement extends CRM_Core_DAO
{
   ...
   * class constructor
   *
   * @return civicrm_hrleaveandabsences_leave_period_entitlement
   */
    ...
    if (!(self::$_import)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('import', $field)) {
          if ($prefix) {
            self::$_import['hrleaveandabsences_leave_period_entitlement'] = & $fields[$name];
          } else {
    ...
    if (!(self::$_export)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('export', $field)) {
          if ($prefix) {
            self::$_export['hrleaveandabsences_leave_period_entitlement'] = & $fields[$name];
          } else {
