...
class CRM_HRLeaveAndAbsences_DAO_LeaveRequestDate extends CRM_Core_DAO
{
   ...
   * class constructor
   *
   * @return civicrm_hrleaveandabsences_leave_request_date
   */
    ...
    if (!(self::$_import)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('import', $field)) {
          if ($prefix) {
            self::$_import['hrleaveandabsences_leave_request_date'] = & $fields[$name];
          } else {
    ...
    if (!(self::$_export)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('export', $field)) {
          if ($prefix) {
            self::$_export['hrleaveandabsences_leave_request_date'] = & $fields[$name];
          } else {
