...
class CRM_HRLeaveAndAbsences_Service_WorkPatternCalendarTest extends BaseHeadlessTest {
  ...
  public function testGetShouldUseTheDefaultWorkPatternIfTheContactHasNoActiveWorkPatternDuringTheContract() {
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[0]['type']);
    $this->assertEquals('2015-01-08', $calendarDates[3]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[3]['type']);
    $this->assertEquals('2015-01-11', $calendarDates[6]['date']);
    $this->assertEquals($workDayTypes['weekend']['value'], $calendarDates[6]['type']);
    $this->assertEquals('2015-01-16', $calendarDates[11]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[11]['type']);
    $this->assertEquals('2015-01-19', $calendarDates[14]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[14]['type']);
  }
  ...
  public function testGetShouldUseTheDefaultWorkPatternIfTheAssignedWorkPatternDoesntCoverTheWholeContractPeriod() {
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[5]['type']);

    $this->assertEquals('2015-01-07', $calendarDates[6]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[6]['type']);
    ...
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[12]['type']);
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[19]['type']);
    ...
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[26]['type']);

    $this->assertEquals('2015-01-31', $calendarDates[30]['date']);
    $this->assertEquals($workDayTypes['weekend']['value'], $calendarDates[30]['type']);
  }
  ...
  public function testGetCanCycleTheWeeksOfAWorkPatternEffectiveBeforeTheAbsencePeriod() {
    ...
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[1]['type']);
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[8]['type']);

    // just checking that the last day is present
    $this->assertEquals('2015-01-10', $calendarDates[9]['date']);
    $this->assertEquals($workDayTypes['weekend']['value'], $calendarDates[9]['type']);
  }
  ...
  public function testGetUsesTheContractStartDateToCycleWeeksIfTheWorkPatternEffectiveDateIsBeforeTheContractStartDate() {
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[4]['type']);
    ...
    // working day
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[7]['type']);
  ...
  public function testItCanGenerateTheCalendarWhenThereAreMultiplesWorkPatternsWithinASingleContractStartAndEndDates() {
    ...
    // working day on it
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[3]['type']);
    ...
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[11]['type']);
  }
  ...
  public function testGetReturnsResultsForContactWithoutAContractAndFillsTheContactWorkPatternPeriodLapsesWithTheDefaultWorkPattern() {
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[1]['type']);
    $this->assertEquals('2016-03-05', $calendarDates[2]['date']);
    $this->assertEquals($workDayTypes['weekend']['value'], $calendarDates[2]['type']);
    $this->assertEquals('2016-03-06', $calendarDates[3]['date']);
    $this->assertEquals($workDayTypes['weekend']['value'], $calendarDates[3]['type']);
    ...
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[5]['type']);
  ...
  public function testGetReturnsResultsForContactWithContractsAndFillsThePeriodLapsesUsingTheDefaultWorkPattern() {
    ...
    $this->assertEquals($workDayTypes['weekend']['value'], $calendarDates[1]['type']);
    ...
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[4]['type']);
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[10]['type']);
    $this->assertEquals('2016-01-12', $calendarDates[11]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[11]['type']);
    $this->assertEquals('2016-01-13', $calendarDates[12]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[12]['type']);
    $this->assertEquals('2016-01-17', $calendarDates[16]['date']);
    $this->assertEquals($workDayTypes['weekend']['value'], $calendarDates[16]['type']);
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[17]['type']);
    $this->assertEquals('2016-01-19', $calendarDates[18]['date']);
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[18]['type']);
    $this->assertEquals('2016-01-20', $calendarDates[19]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[19]['type']);
    $this->assertEquals('2016-01-21', $calendarDates[20]['date']);
    $this->assertEquals($workDayTypes['non_working_day']['value'], $calendarDates[20]['type']);
    ...
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[24]['type']);
    $this->assertEquals('2016-01-26', $calendarDates[25]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[25]['type']);
    $this->assertEquals('2016-01-27', $calendarDates[26]['date']);
    $this->assertEquals($workDayTypes['working_day']['value'], $calendarDates[26]['type']);
