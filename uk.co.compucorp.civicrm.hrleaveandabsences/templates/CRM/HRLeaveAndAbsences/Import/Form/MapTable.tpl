{*
 ...
 +--------------------------------------------------------------------+
*}
{* Leave Request Import Wizard - Data Mapping table used by MapFields.tpl and Preview.tpl *}
  ...
  <div id="map-field">
    {strip}
      <table class="table">
        {if $loadedMapping}
          <tr>
            <th colspan="4">{ts 1=$savedName}Saved Field Mapping: %1{/ts}</td>
          </tr>
        {/if}
        <tr>
        ...
        {section name=cols loop=$columnCount}
          ...
          <tr>
            ...
            <td class="{if $wizard.currentStepName == 'Preview'}labels{/if}">
