{*
 ...
 +--------------------------------------------------------------------+
*}
<div id="bootstrap-theme" class="crm-leave-and-balance-import crm-activity-import-mapfield-form-block">
  <div class="panel">
    <div class="panel-default">
      <div class="panel-header">
        {* Leave Request Import Wizard - Step 2 (map incoming data fields) *}
