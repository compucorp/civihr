...
(function ($, _) {
  ...
  /**
   * Adds a custom class to the quicksearch field
   ...
   */
  function addCustomClassToQuickSearchField () {
    $('#crm-qsearch').hover(
      function () {
        $(this).addClass('search-ongoing');
      },
      function () {
        if (!$('#sort_name_navigation').val().length &&
          !$('.crm-quickSearchField:visible', '#root-menu-div').length) {
