...
!function(t){"use strict";t("body").on("click",".btn-slide",function(i){function n(){t(".civihr-popup").remove(),d.removeClass("civihr-popup-open")}function c(){var i=e.offset(),n=r.clone(!0).appendTo(d).addClass("civihr-popup").attr("id",p.id).addClass(t(p).attr("class"));n.css("top",+i.top+e.outerHeight()).css("left",+i.left-n.width()-e.outerWidth()),n.show(),a(n)}function o(){e.data("attrchange-is-on")||(e.data("attrchange-is-on",!0),e.attrchange(function(){e.hasClass("btn-slide-active")||n()}))}function a(i){i.find("a").click(function(){var i=t(this).parent().index();r.find("li:nth("+i+") a").click()})}function s(){n(),c(),d.addClass("civihr-popup-open")}var e=t(this),d=t("body"),p=e.closest(".crm-entity")[0],r=e.children("ul.panel");!function(){s(),o()}()})}(CRM.$);