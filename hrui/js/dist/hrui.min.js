...
!function(s){"use strict";s(".btn-slide").attrchange(function(t){var e,p,i,a=s("body"),o=s(this);o.hasClass("btn-slide-active")?(p=o.children("ul.panel"),e=o.closest(".crm-entity")[0],p.attr("id",e.id),p.addClass(s(e).attr("class")),p.appendTo(a).addClass("civihr-popup"),i=o.offset(),p.css("top",parseInt(i.top,10)+o.outerHeight()).css("left",parseInt(i.left,10)-(p.width()-o.outerWidth())),a.addClass("civihr-popup-open")):(a.children(".civihr-popup").appendTo(o).removeClass("civihr-popup"),a.removeClass("civihr-popup-open"))})}(CRM.$);