...
!function(p){"use strict";p(".btn-slide").attrchange(function(e){var s,i,t=p(this),o=p("body");t.hasClass("btn-slide-active")?(s=t.children("ul.panel"),s.appendTo(o).addClass("civihr-popup"),i=t.offset(),s.css("top",parseInt(i.top,10)+t.outerHeight()).css("left",parseInt(i.left,10)-(s.width()-t.outerWidth())),o.addClass("civihr-popup-open")):(o.children(".civihr-popup").appendTo(t).removeClass("civihr-popup"),o.removeClass("civihr-popup-open"))})}(CRM.$);
