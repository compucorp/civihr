...
!function(t){"use strict";t("body").on("click",".btn-slide",function(i){function n(){d.children(".civihr-popup").appendTo(p).removeClass("civihr-popup"),d.removeClass("civihr-popup-open")}function a(){p.data("attrchange-is-on")||(p.data("attrchange-is-on",!0),p.attrchange(function(){p.hasClass("btn-slide-active")||n()}))}function e(){o=p.children("ul.panel"),c=p.closest(".crm-entity")[0],o.attr("id",c.id),o.addClass(t(c).attr("class")),o.appendTo(d).addClass("civihr-popup"),s=p.offset(),o.css("top",+s.top+p.outerHeight()).css("left",+s.left-o.width()-p.outerWidth()),d.addClass("civihr-popup-open")}var o,s,c,p=t(this),d=t("body");i.preventDefault(),function(){e(),a()}()})}(CRM.$);